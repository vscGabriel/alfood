...
Para abrir e rodar o projeto, execute npm i para instalar as dependências e

### `npm start:windows` || `yarn start:windows` para SO Windows 8/10/11

### or

### `npm start:unix` || `yarn start:unix` para SO unix
